...
public class DeletarPaciente extends javax.swing.JFrame {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(jTcpf, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jBdeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBdeletarActionPerformed
        ...
        try {    
            ...
            ManterPaciente mt = new ManterPaciente();
        
            p.setCpf(parseInt(jTcpf.getText()));     
            mt.excluir(p);
        } catch (Exception ex) {
            Logger.getLogger(DeletarPaciente.class.getName()).log(Level.SEVERE, null, ex);
        }
